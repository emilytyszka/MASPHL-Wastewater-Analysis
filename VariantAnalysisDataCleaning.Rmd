...
write_xlsx(as.data.frame(all1),
           path = paste0('J:/Wastewater Surveillance/Emily/Variant Analysis/Data/Cleaned/All1.xlsx'))
```
...
write_xlsx(as.data.frame(all2),
           path = paste0('J:/Wastewater Surveillance/Emily/Variant Analysis/Data/Cleaned/All2.xlsx'))
```
...
write_xlsx(as.data.frame(all3),
           path = paste0('J:/Wastewater Surveillance/Emily/Variant Analysis/Data/Cleaned/All3.xlsx'))
```
...
write_xlsx(as.data.frame(all4),
           path = paste0('J:/Wastewater Surveillance/Emily/Variant Analysis/Data/Cleaned/All4.xlsx'))
```
...
write_xlsx(as.data.frame(all5),
           path = paste0('J:/Wastewater Surveillance/Emily/Variant Analysis/Data/Cleaned/All5.xlsx'))
```
...
write_xlsx(as.data.frame(all6),
           path = paste0('J:/Wastewater Surveillance/Emily/Variant Analysis/Data/Cleaned/All6.xlsx'))
```
